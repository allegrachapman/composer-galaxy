...
- name: Max Eisikovits
  source: llm
  quote: studied composition with Max Eisikovits in Timișoara
- name: Pál Kadosa
  source: llm
  quote: His piano teacher at the academy was Pál Kadosa
- name: Leó Weiner
  source: llm
  quote: chamber music with Leó Weiner
- name: Lajos Bárdos
  source: llm
