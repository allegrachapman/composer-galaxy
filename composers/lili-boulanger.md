...
- name: Marcel Tournier
  source: llm
  quote: Her teachers included Marcel Tournier and Alphonse Hasselmans for harp
- name: Alphonse Hasselmans
  source: llm
  quote: Her teachers included Marcel Tournier and Alphonse Hasselmans for harp
- name: Hélène Chaumont
  source: llm
  quote: Hélène Chaumont (mother of Madeleine Chaumont) for piano
- name: Fernand Luquin
  source: llm
  quote: Fernand Luquin for violin
- name: Georges Caussade
  source: llm
  quote: Boulanger studied harmony with Georges Caussade
- name: Paul Vidal
  source: llm
