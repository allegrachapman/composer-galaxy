...
- name: Antoine François Marmontel
  source: llm
  quote: A charming child, a truly artistic temperament; much can be expected of him
- name: Ernest Guiraud
  source: llm
  quote: composition with Ernest Guiraud
- name: Émile Durand
  source: llm
  quote: Debussy would be an excellent pupil if he were less sketchy and less cavalier
- name: César Franck
  source: llm
