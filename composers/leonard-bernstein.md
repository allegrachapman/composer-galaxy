...
thumbnail: https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Leonard_Bernstein_by_Jack_Mitchell_%28high_quality%29.jpg/250px-Leonard_Bernstein_by_Jack_Mitchell_%28high_quality%29.jpg
birth: '1918'
birth_source: infobox
death: '1990'
death_source: infobox
nationality: Lawrence, Massachusetts, U.S.
...
- name: Isabelle Vengerova
  source: llm
  quote: piano with Isabelle Vengerova
- name: Randall Thompson
  source: llm
  quote: orchestration with Randall Thompson
- name: Richard Stöhr
  source: llm
  quote: counterpoint with Richard Stöhr
- name: Renée Longy-Miquelle
  source: llm
  quote: score reading with Renée Longy-Miquelle
- name: Serge Koussevitzky
  source: llm
  quote: Bernstein studied conducting with the BSO's music director, Serge Koussevitzky
- name: Helen Coates
  source: wiki
...
- name: Yutaka Sado
  source: wiki
  source_url: https://en.wikipedia.org/wiki/List_of_music_students_by_teacher:_A_to_B
- name: Elyakum Shapirra
  source: wiki
  source_url: https://en.wikipedia.org/wiki/List_of_music_students_by_teacher:_A_to_B
- name: Jeannette Sorrell
  source: wiki
  source_url: https://en.wikipedia.org/wiki/List_of_music_students_by_teacher:_A_to_B
- name: David Stahl
  source: wiki
