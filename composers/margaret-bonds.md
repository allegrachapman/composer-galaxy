...
nationality: Chicago, Illinois, US
...
- name: Robert Starer
  source: wiki
- name: Ebba Sundstrom Nylander
  source: wiki
- name: William Levi Dawson
  source: llm
  quote: At 13, she began studying with William Levi Dawson and Florence Price
- name: Emerson Harper
  source: llm
  quote: studied composition with Roy Harris, Robert Starer, and Emerson Harper
- name: Walter Gossett
  source: llm
  quote: She also studied with Walter Gossett
