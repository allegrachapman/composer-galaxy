...
nationality: Lyon, July Monarchy (Kingdom of France)
nationality_source: infobox
era: Romantic
era_source: llm
teachers:
- name: François-Charles Widor
  source: llm
...
- name: Edgard Varèse
  source: llm
  quote: Alexander Schreiner, Edgard Varèse, Hans Klotz, and the Canadian Henri Gagnon
- name: Hans Klotz
  source: llm
  quote: Alexander Schreiner, Edgard Varèse, Hans Klotz, and the Canadian Henri Gagnon
- name: Henri Gagnon
