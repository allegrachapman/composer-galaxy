...
nationality: Vienna, Austrian Empire
...
- name: Franz Amon
  source: llm
  quote: first violinist of his father's orchestra
- name: Joachim Hoffmann
  source: llm
  quote: studied counterpoint and harmony with theorist Professor Joachim Hoffmann
- name: Joseph Drechsler
  source: llm
  quote: taught him exercises in harmony
- name: Anton Kollmann
  source: llm
